...
<div class="container">
    <div class="row">
        <div class="col-8">
        <form action="/satuanBarang" method="post">
        @csrf
            <div class="mb-3">
                <label for="nama_satuan" class="form-label">Nama Satuan</label>
                <input type="text" name="nama_satuan" class="form-control @error('nama_satuan') is-invalid @enderror" id="nama_satuan" value="{{ old('nama_satuan') }}">
                @error('nama_satuan')
