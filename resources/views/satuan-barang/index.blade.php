...
<div class="container">
    ...
    <div class="row my-3">
        <div class="col">
            <a href="/createSatuanBarang" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Satuan Barang</a>
        </div>
    </div>
    <div class="row">
        <div class="col">
        ...
        <tbody>
            ...
            <td>
                ...
                <a href="/editSatuanBarang/{{ $s->id }}" class="text-success"><i class="fas fa-edit"></i></a> | 
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-footer">
                    ...
                    <form action="/satuanBarang/{{ $s->id }}" method="POST">
                    @csrf
                    @method('DELETE')
